...
public class BlockMagneticChest extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        if (player.isSneaking())
            ...
            if (!world.isRemote) {
            	TileEntityMagneticChest tileMagneticChest = (TileEntityMagneticChest) world.getTileEntity(x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack stack) {
    	TileEntityTC tileEntity = (TileEntityTC) world.getTileEntity(x, y, z);
