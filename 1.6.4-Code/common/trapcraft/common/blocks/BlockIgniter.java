...
public class BlockIgniter extends BlockContainer {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
        ...
        {
            TileEntityIgniter tileentityigniter = (TileEntityIgniter)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public void updateIgniterState(World par1World, int par2, int par3, int par4) {
        ...
        TileEntityIgniter igniter = (TileEntityIgniter)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        if (direction != 7) {
            ...
            if(flag) {
            	if(par1World.getBlockId(x + par2, y + par3, z + par4) == 0) {
            		if(par1World.doesBlockHaveSolidTopSurface(x + par2, y + par3 - 1, z + par4)) {
            			par1World.setBlock(x + par2, y + par3, z + par4, Block.fire.blockID);
            		}
            	}
            		
            }
            else if(!flag && par1World.getBlockId(x + par2, y + par3, z + par4) == Block.fire.blockID) {
