...
public class TileEntityFan extends TileEntity implements ITickableTileEntity
{
    ...
    public void tick() {
        ...
        for(Entity entity : list) {
        	...
        	if(Math.abs(entity.getMotion().func_216370_a(facing.getAxis())) < threshholdVelocity)
    ...
    public boolean isPathClear(Entity entity, Direction facing) {
        ...
        for(int l2 = 1; l2 < Math.abs(x + y + z); l2++) {
            ...
            if(Block.func_220055_a(this.world, this.pos.offset(facing, l2), facing.getOpposite())) {
                flag = false;
            }
        }
