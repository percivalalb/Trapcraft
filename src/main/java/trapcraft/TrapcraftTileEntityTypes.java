...
public class TrapcraftTileEntityTypes {
	...
	public static final RegistryObject<TileEntityType<? extends TileEntityMagneticChest>> MAGNETIC_CHEST = TILE_ENTITIES.register("magnetic_chest", () -> new TileEntityType<>(TileEntityMagneticChest::new, Sets.newHashSet(TrapcraftBlocks.MAGNETIC_CHEST.get()), null));
