...
public class ItemRenderHelperGrassCovering implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
	    ...
	    renderer.setOverrideBlockTexture(renderer.getBlockIconFromSideAndMetadata(Block.planks, 1, 0));
	    if(world.getBlockId(x - 1, y, z) == TrapcraftMod.grassCovering.blockID) {
	    ...
	    if(world.getBlockId(x, y, z - 1) == TrapcraftMod.grassCovering.blockID) {
